...
OFFSET_END = 0x190000
files_in = [
    ('bootloader', OFFSET_BOOTLOADER, "./build/bootloader/bootloader.bin"),
    ('partitions', OFFSET_PARTITIONS, "./build/partition_table/partition-table.bin"),
    # ('ota_data_initial', OFFSET_OTA_DATA_INITIAL, sys.argv[3]),
    ('application', OFFSET_APPLICATION, "./build/hello_world.bin"),
]
file_out = "QIO.bin"
